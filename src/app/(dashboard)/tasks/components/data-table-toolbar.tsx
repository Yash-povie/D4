          ...
          >
            ...
            <SelectContent>
              ...
              {priorities.map((priority) => (
                ...
                >
                  <div className="flex items-center">
                    {(priority as { icon?: React.ComponentType<{ className?: string }> }).icon && (
                      <>{(() => { const Icon = (priority as { icon?: React.ComponentType<{ className?: string }> }).icon; return Icon ? <Icon className="mr-2 h-4 w-4 text-muted-foreground" /> : null; })()}</>
                    )}
                    {priority.label}
                  </div>
                </SelectItem>
