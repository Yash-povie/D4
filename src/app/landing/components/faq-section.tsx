...
const faqItems: FaqItem[] = [
  {
    ...
    answer:
      'Integration is simple. The components are built with shadcn/ui for modern React and Next.js projects. Copy the component code, install any required dependencies, and paste it into your app. Each component includes installation guidance and example usage.',
  },
  {
    value: 'item-2',
  ...
  },
  {
    ...
    answer:
      'Our components are designed for modern React and Next.js applications. We use TypeScript, Tailwind CSS, and shadcn/ui conventions, with supporting tools such as React Hook Form, TanStack Table, and Zustand where appropriate.',
  },
  {
    value: 'item-6',
