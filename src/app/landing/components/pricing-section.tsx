            ...
            <div className="grid lg:grid-cols-3">
              {plans.map((plan, index) => (
                ...
                >
                  ...
                  {/* onClick={() => handleCheckout(isYearly ? plan.yearlyPriceId : plan.monthlyPriceId)}
                    ...
                    >
                      {loading === (isYearly ? plan.yearlyPriceId : plan.monthlyPriceId) ? 'Processing...' :  : (
